//////////////////////////////////////////////////////////
// Horizontal Jukebox
// Horizontal layout for attract-mode front end https://attractmode.org/
//
...
local music_late_70s = ["01 Call Me.m4a",
						...
						"06 Rock and Roll All Nite (_Alive!_.m4a",
						"01 Highway to Hell.m4a",
						"16 We Will Rock You.m4a"
						];
...
local music_early_80s = [   "01 Call Me.m4a",
							...
							"01 I Love Rock 'N Roll.m4a",
							"09 Situation.m4a",
							"01 More Than This.m4a",
							"01 Electric Avenue.m4a",
							"Don't you want me.mp3",
							"02 Echo Beach.m4a",
							"02 The Safety Dance.m4a",
							"01 Dance Hall Days.m4a",
							"03 Sharp Dressed Man.m4a",
							"08 Separate Ways.m4a"
							];
...
local music_mid_80s = [ "1-03 Fall On Me (Remastered).m4a",
						...
						"01 Live Is Life (Digitally Remastere.m4a",
						"01 You Spin Me Right Round.mp3",
						"03 Relax.m4a",
						"04 Just Like Honey.m4a",
						"02 Rock You Like a Hurricane.m4a"
						];
...
local music_late_80s = ["01 Its A Sin.mp3",
						...
						"02 Wild Thing.m4a",
						"03 Pour Some Sugar On Me.m4a",
						"03 Just Like Heaven.m4a",
						"01 Beds Are Burning.m4a",
						"1-12 True Faith.m4a",
						"08 Orange Crush.m4a",
						"01 Never Let Me Down Again.m4a",
						
						];
local music_early_90s = [	"04 The Sign (Remastered).m4a",
							"1-05 One.m4a",
							"03 Personal Jesus.m4a",
							"03 Gangsta's Paradise (feat. L.V.).m4a",
							"03 Wonderwall.m4a",
							"02 Queer.m4a",
							"03 Self Esteem.m4a",
							"05 If It Makes You Happy.m4a",
							"05 Smells Like Teen Spirit.m4a",
							"06 Losing My Religion.m4a",
							"13 Don't Speak.m4a",
							"16 Everybody Hurts.m4a"
							];
...
local music_dir = "/home/patrick/.attract/sounds/musik/"
...
local t = fe.add_artwork( "snap", 1035, 354 , 755, 511 ); // x, y, width, height
t.trigger = Transition.EndNavigation;

t = fe.add_artwork( "marquee", 135, 82, 1678, 222 );
t.trigger = Transition.EndNavigation;

local lb = fe.add_listbox( 135, 350, 770, 680 );
lb.charsize = 48;
lb.set_selbg_rgb( 255, 255, 255 );
lb.set_sel_rgb( 0, 0, 0 );
lb.sel_style = Style.Bold;

fe.add_image( "frame_horz.png", 0, 0 );

local l = fe.add_text( "[Year]", 1000, 900, 500, 120 );
l.charsize = 100
l.set_rgb( 200, 200, 70 );
l.align = Align.Left;
l.style = Style.Bold;

l = fe.add_text( "[Manufacturer]", 830, 1000, 800, 60 );
l.charsize = 32
l.set_rgb( 200, 200, 70 );
//l.align = Align.Left;

l = fe.add_text( "[ListEntry]/[ListSize]", 1510, 1030, 290, 20 );
l.charsize = 18
l.set_rgb( 200, 200, 70 );
l.align = Align.Right;
